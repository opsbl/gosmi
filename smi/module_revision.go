...
func (i *Instance) GetFirstRevision(smiModulePtr *types.SmiModule) *types.SmiRevision {
	if smiModulePtr == nil {
		return nil
	}
...
func (i *Instance) GetNextRevision(smiRevisionPtr *types.SmiRevision) *types.SmiRevision {
...
func (i *Instance) GetRevisionLine(smiRevisionPtr *types.SmiRevision) int {
	if smiRevisionPtr == nil {
		return 0
	}
	revisionPtr := (*internal.Revision)(unsafe.Pointer(smiRevisionPtr))
