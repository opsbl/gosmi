...
func (i *Instance) GetFirstImport(smiModulePtr *types.SmiModule) *types.SmiImport {
	if smiModulePtr == nil {
		return nil
	}
...
func (i *Instance) GetNextImport(smiImportPtr *types.SmiImport) *types.SmiImport {
	if smiImportPtr == nil {
		return nil
	}
...
func (i *Instance) IsImported(smiModulePtr *types.SmiModule, importedModulePtr *types.SmiModule, importedName string) bool {
