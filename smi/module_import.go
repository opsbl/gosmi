...
// GetFirstImport C -> SmiImport *smiGetFirstImport(SmiModule *smiModulePtr)
...
// GetNextImport C -> SmiImport *smiGetNextImport(SmiImport *smiImportPtr)
...
// IsImported C -> int smiIsImported(SmiModule *smiModulePtr, SmiModule *importedModulePtr, char *importedName)
