...
func (h *Handle) GetNextChildObject(startNodePtr *Node, modulePtr *Module, nodekind types.NodeKind) *Object {
	return GetNextChildObject(startNodePtr, modulePtr, nodekind)
}

func (h *Handle) FindObjectByModuleNameAndNode(module string, nodePtr *Node) *Object {
	return FindObjectByModuleAndNode(h.FindModuleByName(module), nodePtr)
}

func (h *Handle) FindObjectByModuleAndNode(modulePtr *Module, nodePtr *Node) *Object {
	return FindObjectByModuleAndNode(modulePtr, nodePtr)
}

func (h *Handle) FindObjectByNode(nodePtr *Node) *Object {
	return FindObjectByNode(nodePtr)
}
