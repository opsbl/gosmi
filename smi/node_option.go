...
func (i *Instance) GetFirstOption(smiComplianceNodePtr *types.SmiNode) *types.SmiOption {
...
func (i *Instance) GetNextOption(smiOptionPtr *types.SmiOption) *types.SmiOption {
	if smiOptionPtr == nil {
		return nil
	}
...
func (i *Instance) GetOptionNode(smiOptionPtr *types.SmiOption) *types.SmiNode {
	if smiOptionPtr == nil {
		return nil
	}
...
func (i *Instance) GetOptionLine(smiOptionPtr *types.SmiOption) int {
	if smiOptionPtr == nil {
		return 0
	}
	optionPtr := (*internal.Option)(unsafe.Pointer(smiOptionPtr))
