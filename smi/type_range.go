...
func (i *Instance) GetFirstRange(smiTypePtr *types.SmiType) *types.SmiRange {
	if smiTypePtr == nil {
		return nil
	}
...
func (i *Instance) GetNextRange(smiRangePtr *types.SmiRange) *types.SmiRange {
	if smiRangePtr == nil {
		return nil
	}
...
func (i *Instance) GetMinMaxRange(smiType *types.SmiType) *types.SmiRange {
	if smiType == nil {
		return nil
	}
	currRange := i.GetFirstRange(smiType)
	if currRange == nil {
		return nil
	}
	...
	for ; currRange != nil; currRange = i.GetNextRange(currRange) {
		switch baseType {
		case types.BaseTypeInteger32:
