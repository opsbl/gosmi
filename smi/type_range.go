...
// GetFirstRange C -> SmiRange *smiGetFirstRange(SmiType *smiTypePtr)
...
// GetNextRange C -> SmiRange *smiGetNextRange(SmiRange *smiRangePtr)
...
// GetMinMaxRange C -> int smiGetMinMaxRange(SmiType *smiType, SmiValue *min, SmiValue *max)
