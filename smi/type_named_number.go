...
func (i *Instance) GetFirstNamedNumber(smiTypePtr *types.SmiType) *types.SmiNamedNumber {
	if smiTypePtr == nil {
		return nil
	}
...
func (i *Instance) GetNextNamedNumber(smiNamedNumberPtr *types.SmiNamedNumber) *types.SmiNamedNumber {
