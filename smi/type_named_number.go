...
// GetFirstNamedNumber C -> SmiNamedNumber *smiGetFirstNamedNumber(SmiType *smiTypePtr)
...
// GetNextNamedNumber C -> SmiNamedNumber *smiGetNextNamedNumber(SmiNamedNumber *smiNamedNumberPtr)
