...
func (i *Instance) GetFirstRefinement(smiComplianceNodePtr *types.SmiNode) *types.SmiRefinement {
...
func (i *Instance) GetNextRefinement(smiRefinementPtr *types.SmiRefinement) *types.SmiRefinement {
...
func (i *Instance) GetRefinementNode(smiRefinementPtr *types.SmiRefinement) *types.SmiNode {
	if smiRefinementPtr == nil {
		return nil
	}
...
func (i *Instance) GetRefinementType(smiRefinementPtr *types.SmiRefinement) *types.SmiType {
	if smiRefinementPtr == nil {
		return nil
	}
	refinementPtr := (*internal.Refinement)(unsafe.Pointer(smiRefinementPtr))
...
func (i *Instance) GetRefinementWriteType(smiRefinementPtr *types.SmiRefinement) *types.SmiType {
	if smiRefinementPtr == nil {
		return nil
	}
	refinementPtr := (*internal.Refinement)(unsafe.Pointer(smiRefinementPtr))
...
func (i *Instance) GetRefinementLine(smiRefinementPtr *types.SmiRefinement) int {
	if smiRefinementPtr == nil {
		return 0
	}
	refinementPtr := (*internal.Refinement)(unsafe.Pointer(smiRefinementPtr))
